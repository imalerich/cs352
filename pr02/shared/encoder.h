...
// binaryToDecimal will return the decimal number for the corresponding binary 
// form. for eg. decimal [5] for binary [101].
int binaryToDecimal(long n);

// decimalToBinary will return the binary form for the corresponding decimal form. 
// for eg. binary [101] for decimal [5] 
...
// representaion of a given string(Encoding is based on encoding array at the top of this file)
